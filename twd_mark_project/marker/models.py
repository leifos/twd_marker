...
class AssessmentSheet(models.Model):
    firstname = models.CharField(max_length=64, verbose_name='Please enter your first name')
    lastname = models.CharField(max_length=64, verbose_name='Please enter your last name')
    studentno = models.CharField(max_length=8, unique=True, verbose_name='Please enter your student no (without the letter)')
    lab = models.IntegerField(default=0, choices=LAB_CHOICES, verbose_name='Please select the lab you are in')
    pa = models.URLField(verbose_name='PythonAnyhwere Link to your deployed app: i.e. http://<username>.pythonanywhere.com/rango/',default='')
    github_username = models.CharField(max_length=64, verbose_name='Your GitHub Account name i.e. leifos',default='')
    github_repo = models.URLField(verbose_name='Github link to tango with django, i.e. https://github.com/leifos/tango_with_django',default='')
...
class AssessmentSheetForm(forms.ModelForm):
    notes = forms.CharField(widget=forms.Textarea, help_text='Please enter any exceptional circumstances that should be considered when marking your project (incidents need to be recorded in MyCampus for us to verify your claims).', required=False)

    class Meta:
        # Provide an association between the ModelForm and a model
        model = AssessmentSheet
        fields = ('firstname','lastname','studentno','lab','chapter3','chapter4','chapter5','chapter6','chapter7',
